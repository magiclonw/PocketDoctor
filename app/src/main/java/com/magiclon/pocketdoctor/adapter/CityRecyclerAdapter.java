...
import com.magiclon.pocketdoctor.holder.CharacterHolder;
import com.magiclon.pocketdoctor.holder.CityHolder;
import com.magiclon.pocketdoctor.holder.HotCityHolder;
import com.magiclon.pocketdoctor.holder.LocateViewHolder;
import com.magiclon.pocketdoctor.model.City;
import com.magiclon.pocketdoctor.model.Contact;
import com.magiclon.pocketdoctor.utils.PinyinUtils;
...
public class CityRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CityRecyclerAdapter(Context mContext, List<City> mCitys) {
        ...
        this.mCitys.add(0, new City("当前", "0"));
